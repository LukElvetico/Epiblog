...
function AuthForm({ onLoginSuccess }) {
 ...
 const handleSubmit = async (e) => {
  ...
  // CORREZIONE FINALE: L'URL DEVE ESSERE /api/v1/register e /api/v1/login
    // Perchè server.js usa server.use('/api/v1', authRouter);
  const endpoint = isRegisterMode
   ? 'http://localhost:4000/api/v1/register' // CORRETTO
   : 'http://localhost:4000/api/v1/login';   // CORRETTO
